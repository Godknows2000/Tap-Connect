...
class BeerData {
  ...
  static final List<Beer> dummyBeers = [
    ...
    Beer(
      ...
      type: 'Stout',
      location: 'Zimbabwe',
      imagePath: 'assets/rated_breweries_4.jpg',
      rating: 1.0,
      ratingCount: 1500,
      price: '0.80',
      breweryId: 'brewery_3',
  ...
  static final List<Brewery> dummyBreweries = [
    Brewery(
      ...
      imagePath: 'assets/rated_breweries_1.jpg',
      averageRating: 4.0,
      ratingCount: 1500,
    ),
    Brewery(
      ...
      imagePath: 'assets/rated_breweries_3.jpg',
      averageRating: 4.3,
      ratingCount: 800,
    ),
    Brewery(
      ...
      imagePath: 'assets/rated_breweries_2.jpg',
      averageRating: 3.8,
      ratingCount: 600,
    ),
    Brewery(
