...
class TopRatedBeers extends StatefulWidget {
  const TopRatedBeers({super.key});

  @override
  _TopRatedBeersState createState() => _TopRatedBeersState();
}

class _TopRatedBeersState extends State<TopRatedBeers> {
  String _searchQuery = '';
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                filteredBeers.sort((a, b) {
                  ...
                  return bRating.compareTo(aRating); // Sort by rating
                });

                return filteredBeers.isEmpty
                    ? const Center(
                        child: Text(
                          'No top rated beers found',
